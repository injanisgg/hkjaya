    ...
    <div className='pb-12 lg:pb-0'>
        ...
        <div className='p-5 bg-slate-50'>
            <div className="flex flex-col items-center justify-center">
                ...
                <div className='flex flex-col lg:flex-row justify-around items-center my-5 gap-3 lg:justify-center'>
                    <div className="flex flex-col gap-2 items-center flex-1 max-w-xs sm:max-w-sm">
                        <img src={Slogan1} alt="Gambar slogan 1" className='w-20 md:w-32 xl:w-48'/>
                        <p className='font-bold text-lg text-center'>Paling Murah</p>
                        <div className="text-center">
                            <p className='text-base w-fit'>
                                Dijamin harga murah dan ramah untuk
                                pelajar, mahasiswa, dan semua orang
                            </p>
                        </div>
                    </div>
                    <div className="flex flex-col gap-4 items-center flex-1 max-w-xs sm:max-w-sm">
                        <img src={Slogan2} alt="Gambar slogan 1" className='w-20 md:w-32 xl:w-48'/>
                        <p className='font-bold text-lg text-center'>Paling Lengkap</p>
                        <div className="text-center">
                            <p className='text-base w-fit'>
                                Semua ada di ATK HK JAYA dari alat
                                tulis kantor, buku, hingga peralatan
                            </p>
                        </div>
                    </div>
                    <div className="flex flex-col gap-2 items-center flex-1 max-w-xs sm:max-w-sm">
                        <img src={Slogan3} alt="Gambar slogan 1" className='w-20 md:w-32 xl:w-48'/>
                        <p className='font-bold text-lg text-center'>Garansi Kualitas</p>
                        <div className="text-center">
                            <p className='text-base w-fit'>
                                Produk-produk ATK HK JAYA dipastikan
            ...
            <div className='p-5'>
                ...
                <div className='flex flex-wrap gap-3 items-center justify-evenly my-5'>
                    <div className="flex flex-col p-2 hover:cursor-pointer gap-2 items-center" onClick={redirectToAlatSeni}>
                        <img src={AlatSeni} alt="Gambar slogan 1" className='w-36 lg:w-40 xl:w-48 rounded-xl'/>
                    ...
                    <div className="flex flex-col p-2 hover:cursor-pointer gap-2 items-center" onClick={redirectToATK}>
                        <img src={ATK} alt="Gambar slogan 1" className='w-36 lg:w-40 xl:w-48 rounded-xl'/>
                    ...
                    <div className="flex flex-col p-2 hover:cursor-pointer gap-2 items-center" onClick={redirectToKertas}>
                        <img src={Kertas} alt="Gambar slogan 1" className='w-36 lg:w-40 xl:w-48 rounded-xl'/>
                    ...
                    <div className="flex flex-col p-2 hover:cursor-pointer gap-2 items-center" onClick={redirectToPeralatan}>
                        <img src={Peralatan} alt="Gambar slogan 1" className='w-36 lg:w-40 xl:w-48 rounded-xl'/>
